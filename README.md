...
1. Download [`decomp-depot.desktop`](https://raw.githubusercontent.com/the-outcaster/ship-of-harkinian-updater/main/decomp-depot.desktop) (right-click → Save Link As...)
2. Place it in `~/Desktop/` or `~/.local/share/applications/`
3. Double-click to launch

### Any Linux distro
```bash
curl -L https://raw.githubusercontent.com/the-outcaster/ship-of-harkinian-updater/main/decomp-depot.sh | sh
```

Or clone and run:
```bash
git clone https://github.com/the-outcaster/ship-of-harkinian-updater.git
